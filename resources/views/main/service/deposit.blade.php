...
<div class="container-fluid px-0">
    <img src="{{ url('picture/410.jpg') }}" alt="บริการเงินฝาก" class="img-fluid w-100">
    <div class="row mx-0">
        <div class="col-md-3 mt-3">
            <img src="{{ url('picture/S__11649199.png') }}" class="img-fluid w-100">
        </div>
        <div class="col-md-9">
            <p class="text-success my-3 kanit-font" style="font-size: 2.5rem; font-family: 'Prompt', sans-serif;">เงินฝาก / เงินฝากพิเศษ</p>
    ...
    <div>
        ...
        ['id' => 'deposit-6', 'image' => '422.jpg', 'icon' => 'S__11649201.png', 'title' => 'ลักษณะบริการ', 'conditions' => ['เป็นบัญชีเพื่อการออมเงินแบบมีเป้าหมายเพื่อการทำกุรบาน', 'การถอนเงินจะกระทำได้กรณีทำกุรบานหรือถอนเพื่อปิดบัญชีเท่านั้น'], 'service_conditions' => ['เปิดบัญชีครั้งแรกไม่ต่ำกว่า 500 บาท', 'ฝากครั้งต่อไปไม่ต่ำกว่า 200 บาท', 'การถอนเงินจะกระทำได้กรณีทำกุรบานหรือถอนเพื่อปิดบัญชีเท่านั้น']],
            ...
            <div class="my-5" id="{{ $deposit['id'] }}">
                <img src="{{ url('picture/' . $deposit['image']) }}" class="img-fluid w-100">
                <div class="row mx-0 my-3">
                    <div class="col-md-4">
                        <img src="{{ url('picture/' . $deposit['icon']) }}" class="img-fluid w-100">
                    </div>
                    <div class="col-md-8">
