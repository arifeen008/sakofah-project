...
@section('content')
    <div class="card m-3">
        <div class="card-body">
            <b class="h3 card-title">รายการสินเชื่อ</b><hr>
            @if (count($data) > 0)
                        ...
                        @foreach ($data as $item)
                            <tr>
                                ...
                                <td class="text-center">
                                    ...
                                    <a href="{{ url('delete_credit/' . $item->id_credit) }}"
                                        class="btn btn-danger delete"><i class="fas fa-dumpster"></i></a>
                                </td>
                            </tr>
                        @endforeach
                    </tbody>
            ...
            @else
                <div class="card-title text-center">ไม่มีสินเชื่อที่ค้นหา</div>
            @endif
