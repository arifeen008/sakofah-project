        ...
        <div class="card my-3" style="font-family: 'Sarabun';">
            <div class="card-body text-dark">
                ...
                <div class="h-100 d-flex justify-content-center align-items-center">
                    ...
                    <a href="<?php echo site_url('officer/accept_credit_consider3/' . $result->credit_consider_id) ?>" class="btn btn-success h3 ms-3 accept"><i class="fas fa-check me-2"></i>อนุมัติ</a>
...
<div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="<?php echo site_url('officer/reject_credit_consider3/' . $result->credit_consider_id) ?>" method="post">
