                ...
                <div class="card-text">
                    <form action="#" method="post" class="row g-3">
                        ...
                        <div data-mdb-input-init class="form-outline mb-4">
                            <input type="text" id="form4Example1" class="form-control" maxlength="13" minlength="13"/>
                            <label class="form-label" for="form4Example1">เลขบัตรประชาชน :</label>
                        </div>
                        <div data-mdb-input-init class="form-outline mb-4">
                            <input type="text" id="form4Example1" class="form-control" />
                            <label class="form-label" for="form4Example1">เลขสมาชิก :</label>
                        </div>
                        <div data-mdb-input-init class="form-outline mb-4">
                            <input type="text" id="form4Example1" class="form-control" />
                            <label class="form-label" for="form4Example1">ชื่อ :</label>
                        </div>
                        <div data-mdb-input-init class="form-outline mb-4">
                            <input type="text" id="form4Example1" class="form-control" />
                            <label class="form-label" for="form4Example1">นามสกุล :</label>
                        </div>
                        <select class="form-select" id="form4Example1" aria-label="Default select example">
							...
							<label class="form-label" for="form4Example1">สาขา :</label>
                        </select>
